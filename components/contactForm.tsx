  ...
  return (
    <Section dir="rtl" $data={sectionData} $isMobile={isMobile}>
      ...
      <Form $isMobile={isMobile}>
        <Input $isMobile={isMobile} type="text" name="name" placeholder="نام" required onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
            setFormData({ ...formData, name: e.target.value });
          }}  />
        <Input $isMobile={isMobile} type="number" name="phone" placeholder="شماره تلفن" required onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        />
        <SubmitButton $data={sectionData} $isMobile={isMobile} onClick={handleSubmit}>
          ارسال
        </SubmitButton>
      </Form>
    </Section>
